...
class KoinModulesTest {
    ...
    fun `koin dependency graph verifies`() {
        val extraTypes = listOf(
            ...
            br.com.tatame.core.network.ProfileApi::class,
            br.com.tatame.core.network.RankingsApi::class,
            ...
            br.com.tatame.core.profile.ProfileRepository::class,
            br.com.tatame.core.rankings.RankingsRepository::class,
