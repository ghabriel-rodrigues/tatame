...
public enum ApiErrorCode {
    ...
    public static let storeCategoryInUse = "category.in_use"
    public static let storeProductNotPurchasable = "store.product_not_purchasable"
    public static let storeSizeRequired = "store.size_required"
    public static let storeSizeInvalid = "store.size_invalid"
