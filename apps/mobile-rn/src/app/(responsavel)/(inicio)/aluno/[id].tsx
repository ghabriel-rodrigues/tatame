/**
 * Dependent detail (ENR.19): GET /v1/responsavel/dependents/:id — class
 * with the full recurring schedule and the next slot; faixa/graduação is an
 * explicit placeholder until the graduation slice. A foreign dependent id
 * is a server-side 404 (no existence leak) and renders the error state.
 */
