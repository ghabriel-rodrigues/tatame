  ...
  return (
    <PhoneCanvas>
      ...
      <Typography sx={{ fontSize: 14, marginTop: '6px', color: 'var(--fg-3)' }}>
        Sua conta está pronta. O dia a dia da academia — check-in, agenda,
        graduação e pagamentos — acontece no aplicativo.
      </Typography>

      <Stack spacing="12px" sx={{ marginTop: '28px' }}>
        <Card variant="tinted">
          <Typography sx={{ fontSize: 13.5, color: 'var(--fg-2)' }}>
            O painel web é exclusivo para administração da academia e para a
        ...
        />
        <Box
          sx={{ display: 'flex', justifyContent: 'center', marginTop: '6px' }}
        >
          {status === 'authed' ? (
            <TatameButton
              variant="ghost"
