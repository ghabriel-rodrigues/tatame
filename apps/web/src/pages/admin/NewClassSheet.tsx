...
export function NewClassSheet({
  ...
  function submit() {
    ...
    if (weekdays.length === 0)
      next['weekdays'] = 'Selecione pelo menos um dia da semana.';
    if (!/^([01]\d|2[0-3]):[0-5]\d$/.test(startTime))
      next['startTime'] = 'Horário inválido.';
    ...
    if (min !== null && max !== null && min > max)
      next['age'] = 'Faixa etária inválida.';
    setErrors(next);
    ...
    >
      <Stack spacing="14px">
        ...
        <Stack spacing="6px">
          ...
          {errors['weekdays'] ? (
            <FormHelperText error>{errors['weekdays']}</FormHelperText>
          ) : null}
        </Stack>
        <Box
        ...
        <Stack spacing="6px">
          ...
          {errors['professor'] ? (
            <FormHelperText error>{errors['professor']}</FormHelperText>
          ) : null}
        </Stack>
        <Box
          sx={{
